...
export default defineNuxtConfig({
  ...
  auth: {
    ...
    baseURL: 'https://testing-stats-front.netlify.app/api/auth',   // production path: must be added to the Allowed callback url on auth0 manager (with /callback/auth0 at the end)
